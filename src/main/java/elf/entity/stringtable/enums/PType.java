package elf.entity.stringtable.enums;


/**
 * @author qxm
 * @create 2022-07-05 11:23
 **/
public enum PType {
    ...
    public static PType getPType(int index) {
        PType result = null;
        switch (index) {
            case 0: result =  PT_NULL;
                break;
            case 1 : result =  PT_LOAD;
                break;
            case 2 : result =  PT_DYNAMIC;
                break;
            case 3: result =  PT_INTERP;
                break;
            case 4 : result =  PT_NOTE;
                break;
            case 5 : result =  PT_SHLIB;
                break;
            case 6: result =  PT_PHDR;
                break;
            case 0x70000000: result = PT_LOPROC;
                break;
            case 0x7fffffff : result =  PT_HIPROC;
                break;
        }
        return result;
    }
